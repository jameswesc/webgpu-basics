...
async function main() {
    ...
    const settings = {
        // [canvas.clientWidth / 2 - 200, canvas.clientHeight / 2 - 75, -1000]
        translate: { x: 0, y: 0, z: -1000 },
        rotation: { x: 180, y: 30, z: 10 },
        scale: { x: 2, y: 2, z: 2 },
    };
    ...
    function render() {
        ...
        mat4.perspective(degToRad(45), aspect, 1, 2000, matrixValues);
